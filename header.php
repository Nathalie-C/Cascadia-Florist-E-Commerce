...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$cascadia_floral_description = get_bloginfo( 'description', 'display' );
			if ( $cascadia_floral_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $cascadia_floral_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
